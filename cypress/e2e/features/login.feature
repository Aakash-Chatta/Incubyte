Feature: To Check login scenario using Cypress
  ...
  Scenario: Login to the given Website
    ...
    Then User enters email as "testuser12345755244545@gmail.com", password as "testuser!12" and creates an account
    Then User does logout and navigates to login page
    Then User logins with email as "testuser12345755244545@gmail.com" and password as "testuser!12"